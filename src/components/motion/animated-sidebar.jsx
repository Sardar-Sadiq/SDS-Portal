...
function useAnimatedSidebarPanel() {
  ...
  if (!context) {
    return { collapsed: false, collapsible: "none", side: "left" };
  }
  return context;
}
  ...
  return createPortal(
    ...
    >
      ...
      <motion.div
        ...
        inert={!context.openMobile ? "true" : undefined}
        tabIndex={-1}
        data-mobile="true"
        ...
        className={cn(
          "pointer-events-auto absolute inset-y-0 flex h-dvh w-[18rem] max-w-[88vw] flex-col overflow-hidden",
...
export const AnimatedSidebarTrigger = forwardRef(function AnimatedSidebarTrigger(
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex size-9 shrink-0 items-center justify-center rounded-xl outline-none transition-colors hover:bg-muted text-muted-foreground hover:text-foreground",
...
export const AnimatedSidebarInset = forwardRef(function AnimatedSidebarInset(
  { className, ...props },
  forwardedRef,
) {
  return (
...
export const AnimatedSidebarHeader = forwardRef(function AnimatedSidebarHeader(
  { className, ...props },
  forwardedRef,
) {
  return (
...
export const AnimatedSidebarContent = forwardRef(function AnimatedSidebarContent(
  { className, ...props },
  forwardedRef,
) {
  return (
...
export const AnimatedSidebarFooter = forwardRef(function AnimatedSidebarFooter(
  { className, ...props },
  forwardedRef,
) {
  return (
...
export const AnimatedSidebarGroup = forwardRef(function AnimatedSidebarGroup(
  { className, ...props },
  forwardedRef,
) {
  return (
...
export const AnimatedSidebarMenuItem = forwardRef(function AnimatedSidebarMenuItem(
  { className, ...props },
  forwardedRef,
) {
  return (
